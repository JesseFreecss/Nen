...
class PomodoroService : Service() {
    ...
    companion object {
        private const val CHANNEL_ID = "nen_pomodoro"
        private const val ALERT_CHANNEL_ID = "nen_pomodoro_alert"
        ...
        const val ACTION_START = "com.jesse.nen.pomodoro.START"
        const val ACTION_PAUSE = "com.jesse.nen.pomodoro.PAUSE"
        const val ACTION_RESUME = "com.jesse.nen.pomodoro.RESUME"
        const val ACTION_SKIP = "com.jesse.nen.pomodoro.SKIP"
        const val ACTION_STOP = "com.jesse.nen.pomodoro.STOP"
