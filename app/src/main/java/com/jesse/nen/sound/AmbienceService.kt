...
class AmbienceService : Service() {
    ...
    companion object {
        ...
        private const val CHANNEL_ID = "nen_ambience"
        private const val NOTIFICATION_ID = 4

        const val ACTION_PLAY = "com.jesse.nen.sound.PLAY"
        const val ACTION_STOP = "com.jesse.nen.sound.STOP"
        const val ACTION_SET_VOLUME = "com.jesse.nen.sound.SET_VOLUME"
